<script>
    ...
    $: if (showEditModal && !initialized) {
        dialog.showModal();
        currentName = $guestTasks.currentNameEdit;
        currentImp = $guestTasks.currentImpEdit;
        currentUrg = $guestTasks.currentUrgEdit;
        initialized = true;
    }
    $: if (!showEditModal) {
        initialized = false;
    ...
    async function handleSubmit() {
        ...
        try{
            ...
            await editTask($guestTasks.currentIdEdit, $guestTasks.currentNameEdit, $guestTasks.currentDescEdit, $guestTasks.currentImpEdit, $guestTasks.currentUrgEdit, $guestTasks.currentColEdit);
            dialog.close();
        }
        catch(err) {
            alert(err);
...
>
	...
	<div class='content' on:click|stopPropagation>
        ...
        <input class='task' bind:value={$guestTasks.currentNameEdit} type='text' placeholder='Task Name'/>
        ...
        <div class='col'>
            ...
            <input class='picker' bind:value={$guestTasks.currentColEdit} type='color' />
        </div>
